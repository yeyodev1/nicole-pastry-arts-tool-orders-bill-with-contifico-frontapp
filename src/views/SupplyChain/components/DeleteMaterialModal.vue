  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
    <div class="modal danger-modal" :style="disintegrationStyles">
      <div class="modal-header">
        ...
        <p class="warning-text">Estás a punto de eliminar la materia prima <strong>{{ materialName }}</strong>.</p>
      </div>

      <div class="danger-box">
        <ul>
          <li><i class="fas fa-exclamation-triangle"></i> Se eliminará del catálogo.</li>
