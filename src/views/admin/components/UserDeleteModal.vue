  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
    <div class="modal danger-modal" :style="disintegrationStyles">
      <div class="modal-header">
        ...
        <p class="warning-text">Estás a punto de desvincular a <strong>{{ userName }}</strong> del sistema.</p>
      </div>

      <div class="danger-box">
        <ul>
          <li><i class="fa-solid fa-triangle-exclamation"></i> Perderá acceso inmediato a la plataforma.</li>
          <li><i class="fa-solid fa-triangle-exclamation"></i> No se puede revertir esta acción.</li>
        </ul>
      </div>
      ...
      <div class="actions">
        ...
        <div class="hold-button-wrapper danger">
          ...
          >
            ...
            <span class="label">
              <i class="fa-solid" :class="isSuccessfullyDestroyed ? 'fa-fire' : (progress >= 100 ? 'fa-dumpster-fire' : 'fa-skull-crossbones')"></i>
