...
const DURATION = 1200 // 1.2 seconds for destruction as requested
    ...
    <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
      <div class="modal danger-modal" :style="disintegrationStyles">
        <div class="modal-header">
          ...
          <p class="warning-text">Estás a punto de eliminar el destino <strong>{{ destinationName }}</strong>.</p>
        </div>

        <div class="danger-box">
          <ul>
            <li><i class="fa-solid fa-triangle-exclamation"></i> Se eliminará de la lista de selección diaria.</li>
            <li><i class="fa-solid fa-triangle-exclamation"></i> Las palabras clave asociadas dejarán de filtrar pedidos.</li>
            <li><i class="fa-solid fa-triangle-exclamation"></i> No se puede revertir esta acción de la vista actual.</li>
          </ul>
        </div>

        <div class="actions">
          <button class="btn-cancel" @click="emit('close')">Detener, no borrar</button>
          ...
          <div class="hold-button-wrapper danger">
            ...
            >
              ...
              <span class="label">
                <i class="fa-solid" :class="isSuccessfullyDestroyed ? 'fa-fire' : (progress >= 100 ? 'fa-dumpster-fire' : 'fa-trash-can')"></i>
        ...
        <p class="final-warning">Acción IRREVERSIBLE - 1.2s Hold</p>
      </div>
    </div>
  </Transition>
</template>
...
.modal-overlay {
  ...
  z-index: 4000; // Higher than main modal
  display: flex;
  align-items: center;
