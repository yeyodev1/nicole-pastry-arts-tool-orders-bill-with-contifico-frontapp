...
const DURATION = 1200 // 2 seconds for deletion (slightly faster than order delete)
  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
    <div class="modal danger-modal" :style="disintegrationStyles">
      <div class="modal-header">
        ...
        <p class="warning-text">Estás a punto de eliminar las alertas de restock para <strong>{{ productName }}</strong>.</p>
      </div>

      <div class="danger-box">
        <ul>
          <li><i class="fas fa-exclamation-triangle"></i> Se dejará de monitorear este producto.</li>
          <li><i class="fas fa-exclamation-triangle"></i> No recibirás alertas de stock bajo.</li>
          <li><i class="fas fa-exclamation-triangle"></i> Deberás volvera configurarlo manualmente.</li>
        </ul>
      </div>
      ...
      <div class="actions">
        ...
        <div class="hold-button-wrapper danger">
          ...
          >
            ...
            <span class="label">
              <i class="fas" :class="isSuccessfullyDestroyed ? 'fa-check' : (progress >= 100 ? 'fa-trash' : 'fa-fingerprint')"></i>
              {{ isSuccessfullyDestroyed ? 'ELIMINANDO...' : (isHolding ? 'SOLTAR PARA CANCELAR' : 'MANTÉN PARA ELIMINAR') }}
            </span>
          </button>
        </div>
      </div>
