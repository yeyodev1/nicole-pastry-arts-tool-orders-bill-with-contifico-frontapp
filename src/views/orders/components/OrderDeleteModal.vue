...
const DURATION = 3000 // 3 seconds for destruction
  ...
  <div v-if="isOpen" class="modal-overlay" @click.self="emit('close')">
    <div class="modal danger-modal" :style="disintegrationStyles">
      <div class="modal-header">
        ...
        <p class="warning-text">Estás a punto de eliminar permanentemente el pedido de <strong>{{ customerName }}</strong>.</p>
      </div>

      <div class="danger-box">
        <ul>
          <li><i class="fas fa-exclamation-triangle"></i> La orden desaparecerá del historial.</li>
          <li><i class="fas fa-exclamation-triangle"></i> No se podrá recuperar ni consultar.</li>
          <li><i class="fas fa-exclamation-triangle"></i> Esto revertirá cualquier estado de producción.</li>
        </ul>
      </div>
      ...
      <p class="final-warning">Esta acción es IRREVERSIBLE.</p>
    </div>
  </div>
</template>
...
.modal {
  ...
  transition: transform 0.05s linear; // Fast for the shake effect
}
